...
namespace Enumeration.Generator
{
    ...
    internal partial class EnumerationClassTemplate : EnumerationClassTemplateBase
    {
        /// <summary>
 ...
 if(this.Options.IsNamespaceSpecified) { 
            ...
            this.Write("\tabstract partial class ");
            ...
            this.Write("\r\n\t\t}\r\n\r\n\t\tprotected ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.Options.Symbol.Name));
            this.Write("(Case type)\r\n\t\t{\r\n\t\t\tthis.Type = type;\r\n\t\t}\r\n\r\n");
 ...
 foreach(var method in this.Options.Methods) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(method.Name));
            this.Write("(");
            this.Write(this.ToStringHelper.ToStringWithCulture(string.Join(", ", method.Parameters.Select(p => p.Name))));
            this.Write(");\r\n\t\t}\r\n\r\n\t\t[global::System.ComponentModel.EditorBrowsable(global::System.Compon" +
                    "entModel.EditorBrowsableState.Never)]\r\n\t\tpublic static bool ");
            this.Write(this.ToStringHelper.ToStringWithCulture(method.Name));
            this.Write("(");
 ...
 foreach(var parameter in method.Parameters) { 
            ...
            this.Write("\t\tpublic Case Type { get; }\r\n\t}\r\n");
 if(this.Options.IsNamespaceSpecified) { 
            this.Write("}\r\n");
 } 
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    internal class EnumerationClassTemplateBase
    {
        #region Fields
