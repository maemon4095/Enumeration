...
namespace Enumeration.Generator
{
    ...
    internal partial class EnumerationExtensionTemplate : EnumerationExtensionTemplateBase
    {
        /// <summary>
 ...
 if(this.Options.IsNamespaceSpecified) { 
            ...
            this.Write("\t");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.Options.AccessibilityString));
 ...
 if(this.Options.IsNamespaceSpecified) { 
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    internal class EnumerationExtensionTemplateBase
    {
        #region Fields
